...
.factory('surealServices', function ($q, $location, $http, $timeout,$log) {
    ...
    var getArtistAlbum = function (authData, artistid, asSlides) {
        ...
        var URL = "http://surealmusicwebapi.azurewebsites.net" + "/api/GetArtistAlbum";
        var req = {
            method: 'POST',
            url: URL,
            headers: {
    ...
    var setPlaylistPlayedDetails = function (authData, playlist_id) {
    ...
    var setAlbumPlayedDetails = function (authData, album_id) {
            ...
            // auth_token: "",
            // account_user_id: ""
        $log.debug("Setting SetAlbumPlayedDetails for:" + authData.account_user_id + ":album:" + album_id)
            //**********************************SIGNIN FUNCTION **************************************\
            var d = $q.defer();
    ...
    ///**********************************************************************************************************************
    ///Function to get new albums
    var getCurrentAlbumSongs = function (album_id)
    {
        return gbl_album_songs;
    }
    ...
    //*******
    ///**********************************************************************************************************************
    ///******************************************Get Trending Music for the user*****************************************
    ///**********************************************************************************************************************

    var getTrendingAlbumsForUser = function (authData, asSlides) {
        ...
        var URL = "http://surealmusicwebapi.azurewebsites.net" + "/api/GetTrendingAlbums";
        var req = {
            method: 'POST',
            url: URL,
            headers: {
            ...
            if (asSlides == true) {
                ...
                angular.forEach(response.data.album, function (value) {
                    ...
                    try {
                        ...
                        //Can Buy, Can DownLoad, Can Play (means stream or local), Can Favorites, Can Share, Can follow, Can ratings
                        finaldata.push({ Artist: 'The Ramones', Name: value.name, Options: getAlbumOptions(), ImageURL: albumInfo.album_cover_photo.replace("app.assets", glb_sureal_url + "/app.assets"), Id: value.id });
                    }
                    catch (e) { }
                });//foreach
    ...
    var getTrendingSongsForUser = function (authData, asSlides) {
        ...
        var URL = "http://surealmusicwebapi.azurewebsites.net" + "/api/GetTrendingSongs";
        var req = {
            method: 'POST',
            url: URL,
            headers: {
        ...
        $http(req).success(function (data) {
            ...
            //build comprehensive json reponse into data object
            if (asSlides == true) {
                $log.debug("getRecentlyPlayedSongs: Building Slides");
                ...
                angular.forEach(response.data.songs, function (value) {
                    try {
                        ...
                        var songdata = value.song;
                        var albumInfo = JSON.parse(songdata.album_info);
                        var photoURL = albumInfo.album_cover_photo;

                        var song = (songdata.s);
                        var songInfo = song.song_info;


                        count = count + 1;
                        try {
                            //Can Buy, Can DownLoad, Can Play (means stream or local), Can Favorites, Can Share, Can follow, Can ratings
                            slideTemp.push({ Artist: 'The Ramones', AlbumID: songdata.album_id, Name: song.title, Options: getSongOptions(), ImageURL: photoURL.replace("app.assets", glb_sureal_url + "/app.assets"), Id: song.id });
                        }
                        catch (e) { $log.error("getRecentlyPlayedSongs:" + e.message) }
                    }
                    catch (e) { }
                ...
                $log.debug("getRecentlyPlayedSongs: Building list");
                ...
                angular.forEach(response.data.playlist, function (value) {
                    ...
                    catch (e) { $log.debug("getRecentlyPlayedSongs Error:" + e.message); }
            ...
            $log.debug("getRecentlyPlayedSongs:Success");
            d.resolve(finaldata);

        }).error(function (error) {
            $log.debug("SurealAPI - getRecentlyPlayedSongs Error:" + JSON.stringify(error));
            d.reject(error);
        });
    ...
    var getTrendingArtistsForUser = function (authData, asSlides) {

        // auth_uid: "",
        // auth_token: "",
        // account_user_id: ""
        $log.debug("Getting trending artist for:" + authData.account_user_id)
        //**********************************SIGNIN FUNCTION **************************************\
        var d = $q.defer();

        var URL = "http://surealmusicwebapi.azurewebsites.net" + "/api/GetTrendingArtists";
        var req = {
            method: 'POST',
            url: URL,
            headers: {
        ...
        $http(req).success(function (data) {
                ...
                //build comprehensive json reponse into data object
                if (asSlides == true) {
                    $log.debug("getTrendingArtistsForUser: Building Slides");

                 
                    angular.forEach(response.data.artists, function (artist) {
                        try {
                            ...
                            rawbioPhotos = [];
                                ...
                                try {
                                    ...
                                    $log.debug("Error (2) in getTrendingArtistsForUser:" + e.message)
                                ...
                                try {
                                    ...
                                    $log.debug("Error (3) in getTrendingArtistsForUser:" + e.message);
                                ...
                                try {
                                    ...
                                    $log.debug("Error (3a) in getTrendingArtistsForUser:" + e.message);
                                ...
                                try {
                                    ...
                                    $log.debug("Error (4) in getTrendingArtistsForUser:" + e.message);
                        ...
                        catch (e) { $log.debug("Error (5) in getTrendingArtistsForUser:" + e.message); }
                ...
                $log.debug("getTrendingArtistsForUser:Success");
                d.resolve(finaldata);
     

            }).error(function (error) {
                $log.debug("SurealAPI - getTrendingArtistsForUser Error:" + JSON.stringify(error));
                d.reject(error);
            });
    ...
    var getRecentlyPlayedAlbums = function (authData, asSlides) {
        ...
        $http(req).success(function (data) {
          ...
          //  alert(JSON.stringify(gbl_album_songs));
            if (asSlides == true) {
                angular.forEach(response.data.album, function (value) {
    ...
    var getRecentlyPlayedPlaylists = function (authData, asSlides) {

        // auth_uid: "",
        // auth_token: "",
        // account_user_id: ""
        $log.debug("Getting getRecentlyPlayedPlaylist for:" + authData.account_user_id)
        //**********************************SIGNIN FUNCTION **************************************\
        var d = $q.defer();

        var URL = "http://surealmusicwebapi.azurewebsites.net" + "/api/getRecentlyPlayedPlaylist";
        var req = {
            method: 'POST',
            url: URL,
            headers: {
        ...
        $http(req).success(function (data) {
            ...
            //build comprehensive json reponse into data object
            if (asSlides == true) {
                $log.debug("getRecentlyPlayedPlaylist: Building Slides");
                angular.forEach(response.data.playlist, function (value) {
                    try {
                        ...
                        catch (e) { $log.error("getRecentlyPlayedPlaylist:" + e.message); }
                ...
                $log.debug("getRecentlyPlayedPlaylist: Building list");
                ...
                angular.forEach(response.data.playlist, function (value) {
                    ...
                    catch (e) { $log.debug("getRecentlyPlayedPlaylist Error:" + e.message); }
            ...
            $log.debug("getRecentlyPlayedPlaylist:Success");
            d.resolve(finaldata);

        }).error(function (error) {
            $log.debug("SurealAPI - getRecentlyPlayedPlaylist Error:" + JSON.stringify(error));
            d.reject(error);
        });
    ...
    var getRecentlyPlayedSongs = function (authData, asSlides) {

        // auth_uid: "",
        // auth_token: "",
        // account_user_id: ""
        $log.debug("Getting GetRecentlyPlayedSongs for:" + authData.account_user_id)
        //**********************************SIGNIN FUNCTION **************************************\
        var d = $q.defer();

        var URL = "http://surealmusicwebapi.azurewebsites.net" + "/api/GetRecentlyPlayedSongs";
        var req = {
            method: 'POST',
            url: URL,
            headers: {
  ...
  //  api / GetRecentlyPlayedSongs
  //  api / GetRecentlyPlayedPlaylist
    //**********************************PENDING**************************************\
    //**********************************PENDING**************************************\
    //**********************************PENDING**************************************\
            ...
            if (asSlides == true) {
                ...
                $log.debug("getAlbumDetails: Building Lists");
                    ...
                    try {
                      ...
                      //  gbl_album_songs = response.data.songs;
    ...
    //******************************************************************************************************************
    var getSongByID = function (authData,songID) {

        // auth_uid: "",
        // auth_token: "",
        // account_user_id: ""
     
        $log.debug("Getting getSongByID for:" + authData.account_user_id)
        //**********************************SIGNIN FUNCTION **************************************\
        var d = $q.defer();

        var URL = "http://surealmusicwebapi.azurewebsites.net" + "/api/getSongById";
        var req = {
            method: 'POST',
            url: URL,
            headers: {
        ...
        $http(req).success(function (data) {
            ...
            var finaldata = [];
                ...
                $log.debug("getSongByID: Building list");
                ...
                angular.forEach(response.data.playlist, function (value) {
                    ...
                    catch (e) { $log.debug("getSongByID Error:" + e.message); }
            ...
            $log.debug("getSongByID:Success");
            d.resolve(finaldata);

        }).error(function (error) {
            $log.debug("SurealAPI - getSongByID Error:" + JSON.stringify(error));
            d.reject(error);
        });
    ...
    return {
        ...
        getCurrentAlbumSongs: getCurrentAlbumSongs,
        ...
        getTrendingAlbumsForUser:getTrendingAlbumsForUser,
        getTrendingSongsForUser: getTrendingSongsForUser,
        getTrendingArtistsForUser: getTrendingArtistsForUser,
        ...
        getRecentlyPlayedPlaylists: getRecentlyPlayedPlaylists
    };
})