...
angular.module('surealMusic.controllers', [])
        ...
        .controller('dashboardCtrl', function ($scope, $window, $ionicNavBarDelegate, $rootScope, $state, manageSessionService, $timeout, $log, surealServices) {
            ...
            try {
                ...
                promise.then(function (response) {
                    ...
                    console.error("1:" + JSON.stringify(response));
    ...
    */
    //Data controllers
    .controller('myMusicShowCaseCtrl', function ($scope, $ionicSlideBoxDelegate, getActionSheet, surealServices,manageSettingsService,manageSettingsService)
    {
    ...
    //********************************TRENDING *****************************************************************************************
    .controller('myMusicTrendingCtrl', function ($q, $scope, $window, $timeout, $ionicLoading, surealServices, $ionicSlideBoxDelegate, getActionSheet,manageSettingsService) {
        ...
        var lcl_options = surealServices.getAlbumOptions();
        //Build this list using dynamic query as shown below with exact items.
        $scope.myMusicTrendingAlbums =
        [{
            slide_id: 1, slide: [
              { Artist: "The Ramones", Name: "Buddha-Bar Classical", Options: lcl_options, ImageURL: "https://surealmusicstorage.blob.core.windows.net/images/150c9f1b-1d65-4303-bfde-ee94f9cc3418-.jpg", id: 1 },
              { Artist: "The Ramones", Name: "Dangerous", Optons: lcl_options, ImageURL: "https://surealmusicstorage.blob.core.windows.net/images/ba5f453b-a5bf-4c2c-8d72-900e57b6e984-.jpg", id: 2 },
              { Artist: "Van Halen", Name: '1984', Options: lcl_options, ImageURL: "http://ecx.images-amazon.com/images/I/51WBWyEnFCL.jpg", id: 3 },
              { Artist: "The Ramones", Name: "Ghost", Optons: lcl_options, ImageURL: "https://surealmusicstorage.blob.core.windows.net/images/f41419b3-544e-41ad-906d-ff70d8fec287-.jpg", id: 4 },
              { Artist: "The Ramones", Name: "Bad", Optons: lcl_options, ImageURL: "https://surealmusicstorage.blob.core.windows.net/images/35d4a16b-afad-4c77-9431-903d1a69353b-.jpg", id: 5 }]
        ...
        lcl_options = surealServices.getSongOptions();
        ...
        [{
            slide_id: 1, slide: [
                      ...
                      { Artist: "The Ramones", Name: "Ghost", Optons: lcl_options, ImageURL: "https://surealmusicstorage.blob.core.windows.net/images/f41419b3-544e-41ad-906d-ff70d8fec287-.jpg", id: 4 },
                      { Artist: "Van Halen", Name: '1984', Options: lcl_options, ImageURL: "http://ecx.images-amazon.com/images/I/51WBWyEnFCL.jpg", id: 3 },
                      { Artist: "Cash", Name: 'The Man Comes Around', Options: lcl_options, ImageURL: "http://ecx.images-amazon.com/images/I/41mfMbu0ADL.jpg", id: 5 },
                      { Artist: "Johny Coltrane", Name: 'Blue Train', Options: lcl_options, ImageURL: "http://ecx.images-amazon.com/images/I/51OHUeofS3L.jpg", id: 6 }]
        },
           { slide_id: 2, slide: [
              { Artist: "The Ramones", Name: "Buddha-Bar Classical", Options: lcl_options, ImageURL: "https://surealmusicstorage.blob.core.windows.net/images/150c9f1b-1d65-4303-bfde-ee94f9cc3418-.jpg" },
              { Artist: "The Ramones", Name: "Dangerous", Optons: lcl_options, ImageURL: "https://surealmusicstorage.blob.core.windows.net/images/ba5f453b-a5bf-4c2c-8d72-900e57b6e984-.jpg" },
              { Artist: "The Ramones", Name: "Ghost", Optons: lcl_options, ImageURL: "https://surealmusicstorage.blob.core.windows.net/images/f41419b3-544e-41ad-906d-ff70d8fec287-.jpg" },
              { Artist: "The Ramones", Name: "Bad", Optons: lcl_options, ImageURL: "https://surealmusicstorage.blob.core.windows.net/images/35d4a16b-afad-4c77-9431-903d1a69353b-.jpg" }]
   ...
   //    
        ...
        lcl_options = surealServices.getArtistOptions();
        ...
        $scope.myMusicTrendingArtists = 
                [{
                    slide_id: 1, slide: [
                      { Artist: "The Ramones", Name: "Buddha-Bar Classical", Options: lcl_options, ImageURL: "https://surealmusicstorage.blob.core.windows.net/images/150c9f1b-1d65-4303-bfde-ee94f9cc3418-.jpg" },
                      { Artist: "The Ramones", Name: "Dangerous", Optons: lcl_options, ImageURL: "https://surealmusicstorage.blob.core.windows.net/images/ba5f453b-a5bf-4c2c-8d72-900e57b6e984-.jpg" },
                      { Artist: "Van Halen", Name: '1984', Options: lcl_options, ImageURL: "http://ecx.images-amazon.com/images/I/51WBWyEnFCL.jpg" },
                     { Artist: "The Ramones", Name: "Ghost", Optons: lcl_options, ImageURL: "https://surealmusicstorage.blob.core.windows.net/images/f41419b3-544e-41ad-906d-ff70d8fec287-.jpg" },
                      { Artist: "The Ramones", Name: "Bad", Optons: lcl_options, ImageURL: "https://surealmusicstorage.blob.core.windows.net/images/35d4a16b-afad-4c77-9431-903d1a69353b-.jpg" }]
                },
                   { slide_id: 2, slide: [
...
//********** INTEGRATION WORK END**************************************************************************************************************
        ...
        //********************************Whats New *****************************************************************************************
        //********** INTEGRATION WORK END**************************************************************************************************************
    .controller('myMusicWhatsNewCtrl', function ($scope,$log, $ionicSlideBoxDelegate,$timeout, getActionSheet, surealServices, manageSettingsService) {
